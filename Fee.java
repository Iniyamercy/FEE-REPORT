...
public class Fee extends Frame {
		...
		Fee()
		{
			...
			String language[] = {"2021","2020","2019", "2018","2017","2016", "2015", "2014" };
			...
			ImageIcon i2 = new ImageIcon("C:\\Users\\Mercy\\Pictures\\Screenshots\\sibiya.png");
			...
			area2 = new JTextArea();
			area2.setBounds(600, 540, 600, 600);
			...
			Receipt.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e)
				{
					...
					if (rb1.isSelected())
					{
						area2.setText(area2.getText()+ "Wants to Join in "
